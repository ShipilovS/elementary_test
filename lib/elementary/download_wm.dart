...
import 'package:elementary_test/elementary/download_widget.dart';

abstract class IDownloadWm implements IWidgetModel {
...
class DownloadWm extends WidgetModel<DownloadScreen, DownloadModel>
  ...
  final Dio _dio;
  final String _url = 'https://github.com/ShipilovS/cough-audio-stream/blob/master/output.wav';
